...
public class ArrayLifeFieldTestNextGeneration {
    ...
    public static Collection<Object[]> data() {
        Object[][] data = new Object[][] {
            ...
            { 5, 5, new int[][] {{1,1},{1,2},{2,1},{2,2},{0,3},{0,4},{4,3},{4,4}}, 100, new int[][] {{1,1},{1,2},{2,1},{2,2},{0,3},{0,4},{4,3},{4,4}} },
            { 5, 5, new int[][] {{1,1},{1,2},{2,1},{2,2},{0,3},{0,4},{4,3},{4,4}}, 101, new int[][] {{1,1},{2,1},{2,2},{0,4},{4,3},{4,4}} },
