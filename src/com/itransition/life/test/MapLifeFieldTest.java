...
import com.itransition.life.core.MapLifeField;
...
public class MapLifeFieldTest {
    ...
    public MapLifeFieldTest(int width, int height, int[][] initialCells, int epochCount, int[][] finalCells) {
        this.width = width;
        this.height = height;
    ...
    public void testNextGeneration() throws Exception {
        MapLifeField field = new MapLifeField(width,height);
